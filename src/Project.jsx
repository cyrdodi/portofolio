  ...
  return (
    <div className='px-4 py-2 my-4 transition ease-in-out delay-75 border rounded-lg text-green-50 border-green-50 hover:text-green-100 hover:bg-green-800'>
      ...
      <ul className="flex gap-2">
        <li className="px-2 py-0.5 text-sm bg-green-300 text-green-950 rounded-2xl">Laravel</li>
        <li className="px-2 py-0.5 text-sm bg-green-300 rounded-2xl text-green-950">Laravel</li>
      </ul>
    </div>
  )
}
